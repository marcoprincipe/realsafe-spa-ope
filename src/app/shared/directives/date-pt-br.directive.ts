...
/**
 * Diretiva para formatação de datas no formato ptBR.
 */

@Directive({
  selector: '[rsDatePtBR]'
})
export class DatePtBRDirective {
  ...
  @HostListener('keyup')
  public onKeyUp() {
    this._element.value = Formatter.datePtBR(this._element.value);
  }
  ...
  public onBlur() {
    ...
    this._element.value = Formatter.datePtBR(Formatter.padLeft(temp, "0", 8));
